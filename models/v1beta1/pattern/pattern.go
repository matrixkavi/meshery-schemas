...
type DeletePatternModel struct {
	ID   corev1beta1.Id   `json:"id,omitempty" yaml:"id,omitempty"`
...
type MesheryPattern struct {
	...
	ID          corev1beta1.Id           `json:"id,omitempty" yaml:"id,omitempty"`
	Location    corev1beta1.MapObject    `json:"location,omitempty" yaml:"location,omitempty"`
	Name        corev1beta1.Text         `json:"name,omitempty" yaml:"name,omitempty"`
	...
	UserId      corev1beta1.Id   `json:"user_id,omitempty" yaml:"user_id,omitempty"`
...
type MesheryPatternRequestBody struct {
	Name        *string               `json:"name,omitempty" yaml:"name,omitempty"`
	Path        corev1beta1.Text     `json:"path,omitempty" yaml:"path,omitempty"`
	...
	Url         corev1beta1.Endpoint `json:"url,omitempty" yaml:"url,omitempty"`
}
...
type PatternFile struct {
	...
	ID corev1beta1.Uuid `json:"id" yaml:"id"`
	...
	SchemaVersion corev1beta1.VersionString `json:"schemaVersion" yaml:"schemaVersion"`
	...
	Version  corev1beta1.SemverString `json:"version" yaml:"version"`
...
type PatternFile_Metadata struct {
	...
	ResolvedAliases      *map[string]corev1beta1.ResolvedAlias `json:"resolvedAliases,omitempty" yaml:"resolvedAliases,omitempty"`
	AdditionalProperties map[string]interface{}                `json:"-" yaml:"-"`
}
