...
type Invitation struct {
	...
	OwnerId corev1beta1.Uuid `db:"owner_id" json:"owner_id" yaml:"owner_id"`
...
type InvitationPayload struct {
	...
	// OwnerId A Universally Unique Identifier used to uniquely identify entities in Meshery. The UUID core definition is used across different schemas.
	OwnerId *corev1beta1.Uuid `db:"owner_id" json:"owner_id,omitempty" yaml:"owner_id,omitempty"`
