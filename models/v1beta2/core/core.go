...
type ComponentStyles struct {
	...
	BackgroundFit *string `json:"backgroundFit,omitempty" yaml:"backgroundFit,omitempty"`

	// BackgroundHeightRelativeTo How the background image's height is determined. Can be 'none', 'inner', or 'outer'.
	BackgroundHeightRelativeTo *string `json:"backgroundHeightRelativeTo,omitempty" yaml:"backgroundHeightRelativeTo,omitempty"`
	...
	BackgroundWidthRelativeTo *string `json:"backgroundWidthRelativeTo,omitempty" yaml:"backgroundWidthRelativeTo,omitempty"`
	...
	BodyTextWrap *string `json:"bodyTextWrap,omitempty" yaml:"bodyTextWrap,omitempty"`
