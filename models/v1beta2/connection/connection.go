...
type Connection struct {
	...
	CredentialID *corev1beta2.Uuid `db:"credential_id" json:"credential_id,omitempty" yaml:"credential_id"`
	...
	UserID    *corev1beta2.Uuid `db:"user_id" json:"user_id,omitempty" yaml:"user_id"`
	CreatedAt corev1beta2.Time  `db:"created_at" json:"created_at,omitempty" yaml:"created_at"`
	UpdatedAt corev1beta2.Time  `db:"updated_at" json:"updated_at,omitempty" yaml:"updated_at"`

	// DeletedAt SQL null Timestamp to handle null values of time.
	DeletedAt corev1beta2.NullTime `db:"deleted_at" json:"deleted_at,omitempty" yaml:"deleted_at"`
	...
	SchemaVersion corev1beta2.VersionString `gorm:"-" db:"-" json:"schemaVersion" yaml:"schemaVersion"`
}
