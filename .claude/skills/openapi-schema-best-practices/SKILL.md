...
The validator (`build/validate-schemas.js`) checks 22 rules covering every naming convention, structural requirement, and code-generation annotation. All rules are **hard errors** — violations fail the build.
