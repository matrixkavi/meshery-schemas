...
**Dependency**: `oapi-codegen` v2.x (see the `tool` directive in `go.mod` and the `// Code generated by ... version vX.Y.Z` header in generated models for the exact version)
